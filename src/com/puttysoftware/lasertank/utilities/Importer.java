...
public class Importer {
                    ...
                    for (final Object o2 : l) {
                        if (o2 instanceof File) {
                            ...
                            if (ext.equalsIgnoreCase("mod")
                                ...
                                Importer.sourceFrame
                                        .setJMenuBar(Importer.sourceMenus);
                            } else {
                                // Unknown file type
                                CommonDialogs
                                        .showDialog(StringLoader.loadString(
    ...
    private static void init() {
        ...
        Importer.logoLabel = new JLabel(
                StringLoader.loadString(StringConstants.DIALOG_STRINGS_FILE,
                        StringConstants.DIALOG_STRING_IMPORT_INSTRUCTIONS),
