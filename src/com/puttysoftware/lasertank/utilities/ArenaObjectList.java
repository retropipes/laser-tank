...
public class ArenaObjectList {
    ...
    public AbstractArenaObject readArenaObjectG2(final XDataReader reader, final int formatVersion) throws IOException {
    ...
    public AbstractArenaObject readArenaObjectG3(final XDataReader reader, final int formatVersion) throws IOException {
	AbstractArenaObject o = null;
	String UID = StringConstants.COMMON_STRING_SPACE;
    ...
    public AbstractArenaObject readArenaObjectG4(final XDataReader reader, final int formatVersion) throws IOException {
	AbstractArenaObject o = null;
	String UID = StringConstants.COMMON_STRING_SPACE;
    ...
    public AbstractArenaObject readArenaObjectG5(final XDataReader reader, final int formatVersion) throws IOException {
	AbstractArenaObject o = null;
	String UID = StringConstants.COMMON_STRING_SPACE;
    ...
    public AbstractArenaObject readArenaObjectG6(final XDataReader reader, final int formatVersion) throws IOException {
	AbstractArenaObject o = null;
	String UID = StringConstants.COMMON_STRING_SPACE;
