    ...
    private void loadCheatCache() {
        try (InputStream is = CheatManager.class.getResourceAsStream(
                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                        StringConstants.NOTL_STRING_CHEATS_PATH));
    ...
    String enterCheat() {
        final String userInput = CommonDialogs.showTextInputDialog(
                StringLoader.loadString(StringConstants.GAME_STRINGS_FILE,
                        StringConstants.GAME_STRING_CHEAT_PROMPT),
        ...
        if (userInput != null) {
            ...
            if (index != -1) {
                ...
                if (value == JOptionPane.YES_OPTION) {
                    return StringLoader.loadString(
                            StringConstants.GAME_STRINGS_FILE,
                    ...
                    return StringLoader.loadString(
                            StringConstants.GAME_STRINGS_FILE,
                            StringConstants.GAME_STRING_DISABLE_CHEAT)
                            + StringConstants.COMMON_STRING_SPACE
                            + userInput.toLowerCase();
                }
            } else {
