...
class GameReplayEngine {
    ...
    static GameReplayEngine readReplay(final XDataReader reader)
            throws IOException {
    ...
    private static class LinkList {
        ...
        public static LinkList read(final XDataReader reader)
                throws IOException {
    ...
    private static class LinkStack {
        ...
        public static LinkStack read(final XDataReader reader)
                throws IOException {
