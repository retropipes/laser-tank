...
public class LogoManager {
        ...
        static BufferedImageIcon getUncachedLogo(final String name,
                ...
                try {
                        final URL url = LogoManager.LOAD_CLASS
                                        .getResource(LogoManager.DEFAULT_LOAD_PATH
                        ...
                        if (drawing) {
                                if (LogoManager.LOGO_DRAW_FONT == null) {
                                        try (InputStream is = LogoManager.class
                                                ...
                                                LogoManager.LOGO_DRAW_FONT = baseFont
                                                                .deriveFont((float) 18);
                                        } catch (final Exception ex) {
                                                LogoManager.LOGO_DRAW_FONT = Font
                                                                .decode(LogoManager.LOGO_DRAW_FONT_FALLBACK);
                                        }
                                }
                                ...
                                g2.drawString(logoVer, LogoManager.LOGO_DRAW_HORZ
                                                + (LogoManager.LOGO_DRAW_HORZ_MAX - logoVer.length())
                                                                * LogoManager.LOGO_DRAW_HORZ_PCO,
        ...
        public static BufferedImageIcon getLogo() {
                return LogoCache.getCachedLogo(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_LOGO),
                                true);
        }
        ...
        public static BufferedImageIcon getMiniatureLogo() {
                return LogoCache.getCachedLogo(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_MINILOGO),
                                false);
        }
        ...
        public static BufferedImageIcon getMicroLogo() {
                return LogoCache.getCachedLogo(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_MICROLOGO),
                                false);
        }
        ...
        public static Image getIconLogo() {
                return LogoCache.getCachedLogo(
                                StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
                                                StringConstants.NOTL_STRING_ICONLOGO),
                                false);
        }
}
