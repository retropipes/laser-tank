...
class ImageCache {
    ...
    static BufferedImageIcon getCachedImage(final AbstractArenaObject obj,
        ...
        if (!ImageCache.isInCache(name)) {
            final BufferedImageIcon bii = ImageManager.getUncachedImage(obj,
                    useText);
    ...
    private static void expandCache() {
        final ImageCacheEntry[] tempCache = new ImageCacheEntry[ImageCache.cache.length
