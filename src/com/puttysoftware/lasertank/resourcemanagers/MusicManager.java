...
public class MusicManager {
	...
	try {
	    ...
	    try (final InputStream is = MusicManager.LOAD_CLASS.getResourceAsStream(MusicManager.EXTERNAL_LOAD_PATH
		    + LaserTank.getApplication().getArenaManager().getArena().getMusicFilename())) {
