...
public abstract class AbstractArenaData implements Cloneable {
    ...
    public abstract void writeData(final AbstractArena arena, final XDataWriter writer) throws IOException;

    public abstract AbstractArenaData readData(final AbstractArena arena, final XDataReader reader, final int ver)
	    throws IOException;
