...
public abstract class AbstractArenaObject extends CloneableObject {
    ...
    public final void writeArenaObject(final XDataWriter writer) throws IOException {
    ...
    public final AbstractArenaObject readArenaObjectG2(final XDataReader reader, final String ident, final int ver)
	    throws IOException {
    ...
    public final AbstractArenaObject readArenaObjectG3(final XDataReader reader, final String ident, final int ver)
	    throws IOException {
	if (ident.equals(this.getIdentifier())) {
	    final int cc = this.getCustomFormat();
	    if (cc == AbstractArenaObject.CUSTOM_FORMAT_MANUAL_OVERRIDE) {
    ...
    public final AbstractArenaObject readArenaObjectG4(final XDataReader reader, final String ident, final int ver)
	    throws IOException {
	if (ident.equals(this.getIdentifier())) {
	    final int cc = this.getCustomFormat();
	    if (cc == AbstractArenaObject.CUSTOM_FORMAT_MANUAL_OVERRIDE) {
    ...
    public final AbstractArenaObject readArenaObjectG5(final XDataReader reader, final String ident, final int ver)
	    throws IOException {
	if (ident.equals(this.getIdentifier())) {
	    final int cc = this.getCustomFormat();
	    if (cc == AbstractArenaObject.CUSTOM_FORMAT_MANUAL_OVERRIDE) {
    ...
    public final AbstractArenaObject readArenaObjectG6(final XDataReader reader, final String ident, final int ver)
	    throws IOException {
	if (ident.equals(this.getIdentifier())) {
	    final int cc = this.getCustomFormat();
	    if (cc == AbstractArenaObject.CUSTOM_FORMAT_MANUAL_OVERRIDE) {
     ...
     * @throws IOException
     */
    protected void writeArenaObjectHook(final XDataWriter writer) throws IOException {
     ...
     * @throws IOException
     */
    protected AbstractArenaObject readArenaObjectHookG2(final XDataReader reader, final int formatVersion)
	    throws IOException {
     ...
     * @throws IOException
     */
    protected AbstractArenaObject readArenaObjectHookG3(final XDataReader reader, final int formatVersion)
	    throws IOException {
	// Dummy implementation, subclasses can override
	return this;
    }
     ...
     * @throws IOException
     */
    protected AbstractArenaObject readArenaObjectHookG4(final XDataReader reader, final int formatVersion)
	    throws IOException {
	// Dummy implementation, subclasses can override
	return this;
    }
     ...
     * @throws IOException
     */
    protected AbstractArenaObject readArenaObjectHookG5(final XDataReader reader, final int formatVersion)
	    throws IOException {
	// Dummy implementation, subclasses can override
	return this;
    }
     ...
     * @throws IOException
     */
    protected AbstractArenaObject readArenaObjectHookG6(final XDataReader reader, final int formatVersion)
	    throws IOException {
	// Dummy implementation, subclasses can override
	return this;
    }
