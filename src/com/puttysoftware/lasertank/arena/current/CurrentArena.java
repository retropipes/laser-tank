...
public class CurrentArena extends AbstractArena {
	...
	return this.basePath + File.separator
		+ StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE, StringConstants.NOTL_STRING_MUSIC_FOLDER)
		+ File.separator;
    }
	...
	try (XDataReader metaReader = DataIOFactory.createTagReader(
	...
	return DataIOFactory.createTagReader(
	...
	return DataIOFactory.createTagReader(
		this.basePath + File.separator
			+ StringLoader.loadString(
				StringConstants.NOTL_STRINGS_FILE, StringConstants.NOTL_STRING_ARENA_FORMAT_LEVEL)
			+ this.activeLevel
			+ StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
    ...
    private int readArenaMetafileVersion(final XDataReader reader) throws IOException {
    ...
    private void readArenaMetafileG3(final XDataReader reader, final int ver) throws IOException {
    ...
    private void readArenaMetafileG4(final XDataReader reader, final int ver) throws IOException {
	this.levelCount = reader.readInt();
    ...
    private void readArenaMetafileG6(final XDataReader reader, final int ver) throws IOException {
	this.levelCount = reader.readInt();
	this.musicFilename = reader.readString();
    ...
    private void readArenaLevel(final XDataReader reader, final int formatVersion) throws IOException {
	...
	try (XDataWriter metaWriter = DataIOFactory.createTagWriter(
		this.basePath + File.separator
			+ StringLoader.loadString(StringConstants.NOTL_STRINGS_FILE,
				StringConstants.NOTL_STRING_ARENA_FORMAT_METAFILE)
			+ Extension.getArenaLevelExtensionWithPeriod(),
	...
	return DataIOFactory.createTagWriter(
		this.basePath + File.separator
			+ StringLoader.loadString(
				StringConstants.NOTL_STRINGS_FILE, StringConstants.NOTL_STRING_ARENA_FORMAT_LEVEL)
			+ this.activeLevel
    ...
    private void writeArenaMetafile(final XDataWriter writer) throws IOException {
	if (this.prefixHandler != null) {
