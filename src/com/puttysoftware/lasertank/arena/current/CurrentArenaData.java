...
public final class CurrentArenaData extends AbstractArenaData {
	...
	this.fillVirtual();
	this.dirtyData = new LowLevelFlagDataStore(AbstractArenaData.MIN_COLUMNS, AbstractArenaData.MIN_ROWS,
	...
	for (x = 0; x < this.getColumns(); x++) {
		...
		for (z = 0; z < this.getFloors(); z++) {
		    for (w = 0; w < ArenaConstants.NUM_LAYERS; w++) {
			this.setCell(arena, (AbstractArenaObject) this.savedState.getCell(x, y, z, w).clone(), y, x, z,
				w);
		    }
		}
	    }
    ...
    @Override
    public void writeData(final AbstractArena arena, final XDataWriter writer) throws IOException {
	int y, x, z, w;
    ...
    @Override
    public AbstractArenaData readData(final AbstractArena arena, final XDataReader reader, final int formatVersion)
	    throws IOException {
    ...
    private static CurrentArenaData readDataG1(final AbstractArena arena, final XDataReader reader, final int ver)
	    throws IOException {
    ...
    private static CurrentArenaData readDataG2(final AbstractArena arena, final XDataReader reader, final int ver)
	    throws IOException {
	int y, x, z, arenaSizeX, arenaSizeY, arenaSizeZ;
	arenaSizeX = reader.readInt();
	arenaSizeY = reader.readInt();
    ...
    private static CurrentArenaData readDataG3(final AbstractArena arena, final XDataReader reader, final int ver)
	    throws IOException {
	int y, x, z, arenaSizeX, arenaSizeY, arenaSizeZ;
	arenaSizeX = reader.readInt();
	arenaSizeY = reader.readInt();
    ...
    private static CurrentArenaData readDataG4(final AbstractArena arena, final XDataReader reader, final int ver)
	    throws IOException {
	int y, x, z, arenaSizeX, arenaSizeY, arenaSizeZ;
	arenaSizeX = reader.readInt();
	arenaSizeY = reader.readInt();
    ...
    private static CurrentArenaData readDataG5(final AbstractArena arena, final XDataReader reader, final int ver)
	    throws IOException {
    ...
    private static CurrentArenaData readDataG6(final AbstractArena arena, final XDataReader reader, final int ver)
	    throws IOException {
	int y, x, z, w, arenaSizeX, arenaSizeY, arenaSizeZ;
	arenaSizeX = reader.readInt();
	arenaSizeY = reader.readInt();
